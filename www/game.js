...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // ACTIVAR PANTALLA ENCENDIDA AL INICIAR
  requestWakeLock();
});
...
function setupEventListeners() {
  ...
  // --- ARREGLO BOTONES PREMIUM Y AYUDA ---
...
// --- CARTA TOTALMENTE MANUAL (CLICK PARA ABRIR / CLICK PARA CERRAR) ---
...
function handleJoin(res) {
  ...
  // SOLICITAR PANTALLA ENCENDIDA AL ENTRAR A UNA SALA
  requestWakeLock();
...
function updateGameView(room) {
  ...
  // --- SOLUCIÓN DE SINCRONIZACIÓN MÓVIL ---
